...
import com.jieyou.adhd.domain.Booking;
import com.jieyou.adhd.domain.Person;
import com.jieyou.adhd.service.PersonDao;
...
public class PersonController {
    ...
    public @ModelAttribute(SEARCH_MODEL_KEY) Collection<Person> search(Principal currentUser) {
