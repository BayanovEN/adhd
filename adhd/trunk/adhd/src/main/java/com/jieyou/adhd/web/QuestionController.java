...
public class QuestionController {
    ...
    public String create(@Valid Question question, BindingResult result, Model model, HttpServletRequest request) {
        if (result.hasErrors()) {
    ...
    public String update(@Valid Question question, BindingResult result, Model model, HttpServletRequest request) {
        if (result.hasErrors()) {
            model.addAttribute("question", question);
